...
public class TapJoyAdsScript : MonoBehaviour
{
    public Text text;
    ...
    public Cat catcontroller;
    public Board board;    // Start is called before the first frame update
    void Start()
    {
        catcontroller = FindObjectOfType<Cat>();
        ...
        //Tapjoy.OnEarnedCurrency += CurrencyEarned;
	...
	*//*private void CurrencyEarned(string currencyName, int amount)
	{

        board.RewardAdCoins();
        //Cat.gifttimeisOn = true;
        catcontroller.MakeRewardGift();
